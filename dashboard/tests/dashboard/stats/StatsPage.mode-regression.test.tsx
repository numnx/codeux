...
describe("TopCardsModeRenderer Mode Regression", () => {
  ...
  it("renders trend mode cards correctly", () => {
  ...
  it("renders composition mode cards correctly", () => {
    render(<TopCardsModeRenderer mode="composition" {...defaultProps} />);

        ...
        >
            ...
            <div className="flex items-start justify-between mb-6 relative z-10">
                <div className="flex items-center gap-3 min-w-0">
                    ...
                    <div className="min-w-0">
                        ...
                        <span className="text-[9px] font-mono text-slate-500 uppercase tracking-[0.14em]">{source.id}</span>
                    </div>
                </div>
            ...
            <div className="grid grid-cols-3 gap-2 mb-6 relative z-10">
                {([
                    ...
                    >
                        ...
                        <span className="text-[8px] font-bold uppercase tracking-[0.16em] text-slate-500 mt-1.5">
                            {l}
                        </span>
                    </div>
                ))}
            ...
            <div className="mb-6 relative z-10">
                <div className="flex items-center justify-between mb-2">
                    <span className="text-[9px] font-bold uppercase tracking-[0.15em] text-slate-500">Completion</span>
            ...
            <div className="flex items-center justify-between relative z-10 mt-auto">
                ...
                >
                    ...
                    <button className="w-7 h-7 flex items-center justify-center rounded-xl
                                       ...
                                       text-slate-500 hover:text-status-red
                                       transition-colors duration-200"
                            onClick={(event) => {
                                event.stopPropagation();
                                onDelete();
                ...
                <div className="flex items-end justify-between gap-8">
                    ...
                    <div className="flex flex-col items-end gap-4 shrink-0">
                        ...
                        <div className="flex items-center gap-2.5">
                            ...
                            <div className="px-4 py-2 text-[10px] font-bold uppercase tracking-widest rounded-full
                                           bg-black/[0.04] dark:bg-white/[0.04] text-slate-600
                        ...
                        >
                            ...
                            <span className={`text-[9px] font-mono px-1.5 py-0.5 rounded-md
                                ${activeFilter === f
                                    ...
                                    : 'bg-black/[0.06] dark:bg-white/[0.06] text-slate-500'
                                }`}>
                                {counts[f]}
                            </span>
                        </button>

                        ...
                        {loading ? (
                            ...
                            sessions.map((session) => (
                                <a
                                    ...
                                    role="menuitem"
                                    className=" focus-visible:ring-2 focus-visible:ring-signal-500/50 w-full flex flex-col gap-1 px-3 py-2.5 text-left transition-colors hover:bg-black/[0.04] dark:hover:bg-white/[0.04] group"
                                >

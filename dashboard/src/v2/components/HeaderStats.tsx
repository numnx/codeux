        ...
        <div ref={containerRef} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 w-full">
            ...
            <MetricCard hoverTint="group-hover:bg-signal-500/[0.025]" accentHex="#00E0A0">
                ...
                <div className="relative z-10 flex items-center justify-between mb-6">
                    <h3 className="text-slate-600 dark:text-slate-400 font-medium text-xs tracking-widest uppercase group-hover:text-signal-600 dark:group-hover:text-signal-400 transition-colors">Total Tokens</h3>
            ...
            <MetricCard hoverTint="group-hover:bg-cyan-500/[0.025]" accentHex="#00AAFF">
                ...
                <div className="relative z-10 flex items-center justify-between mb-6">
                    <h3 className="text-slate-600 dark:text-slate-400 font-medium text-xs tracking-widest uppercase group-hover:text-cyan-600 dark:group-hover:text-cyan-400 transition-colors">Sprints</h3>
            ...
            <MetricCard hoverTint="group-hover:bg-amber-500/[0.025]" accentHex="#FFB800">
                ...
                <div className="relative z-10 flex items-center justify-between mb-6">
                    <h3 className="text-slate-600 dark:text-slate-400 font-medium text-xs tracking-widest uppercase group-hover:text-amber-600 dark:group-hover:text-amber-400 transition-colors">Open Tasks</h3>
            ...
            <MetricCard hoverTint="group-hover:bg-signal-500/[0.025]" accentHex="#00E0A0">
                ...
                <div className="relative z-10 flex items-center justify-between mb-6">
                    <h3 className="text-slate-600 dark:text-slate-400 font-medium text-xs tracking-widest uppercase group-hover:text-signal-600 dark:group-hover:text-signal-400 transition-colors">Completed Tasks</h3>

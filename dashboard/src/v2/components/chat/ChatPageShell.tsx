    ...
    <PageContainer padding="chat" className="min-h-0 flex-1 flex flex-col gap-6 lg:gap-8 h-full">
      <PageHeader
        ...
        <div className="flex flex-wrap items-center gap-2 w-full xl:w-auto xl:justify-end">
          ...
          <div role="tablist" aria-label="Chat Mode" className="flex flex-wrap items-center rounded-full border border-black/[0.06] bg-white/70 p-1 dark:border-white/[0.06] dark:bg-white/[0.03]"
            onKeyDown={(e) => {
      ...
      <div className="flex-1 min-h-0 flex flex-col md:grid md:grid-cols-[280px_minmax(0,1fr)] xl:grid-cols-[360px_minmax(0,1fr)] gap-6 pb-6">
        {railSlot}

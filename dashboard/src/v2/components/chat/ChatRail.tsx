...
export const ChatRail: FunctionComponent<{
  ...
  return (
    <aside aria-label={title} className="flex flex-col max-h-[40vh] md:max-h-none rounded-3xl border border-black/[0.06] bg-white/80 shadow-[0_2px_20px_rgba(0,0,0,0.04)] backdrop-blur-sm dark:border-white/[0.06] dark:bg-void-800/75 dark:shadow-[0_4px_24px_rgba(0,0,0,0.2)] min-h-[16rem] md:min-h-0 md:h-full">

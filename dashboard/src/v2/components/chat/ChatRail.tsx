...
export const ChatRail: FunctionComponent<{
  ...
  return (
    <aside className="flex min-h-[28rem] flex-col rounded-[1.9rem] border border-black/[0.06] bg-white/70 shadow-[0_2px_20px_rgba(0,0,0,0.04)] backdrop-blur-2xl dark:border-white/[0.06] dark:bg-void-800/60 dark:shadow-[0_4px_24px_rgba(0,0,0,0.2)] lg:min-h-0">

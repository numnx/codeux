...
const SummaryPill: FunctionComponent<{
  ...
  <div className="rounded-xl border border-black/[0.05] bg-white/65 px-3 py-3 backdrop-blur-xl dark:border-white/[0.05] dark:bg-void-900/35">
...
const CounterTile: FunctionComponent<{
  ...
  <div className="rounded-xl border border-black/[0.05] bg-white/68 px-4 py-4 backdrop-blur-xl dark:border-white/[0.05] dark:bg-void-900/35">
    <div className={`mb-2 flex items-center gap-2 text-[9px] font-bold uppercase tracking-[0.14em] ${accent}`}>
...
const StageBand: FunctionComponent<{
  ...
  return (
    <div className="rounded-xl border border-black/[0.05] bg-white/65 px-4 py-4 backdrop-blur-xl dark:border-white/[0.05] dark:bg-void-900/35">
      ...
      <div className="relative z-10">
        ...
        <div className="rounded-xl border border-black/[0.05] bg-black/[0.02] p-3 dark:border-white/[0.05] dark:bg-white/[0.02]">
          <div className="grid gap-3 xl:grid-cols-12">
            <div className="xl:col-span-7 rounded-xl border border-black/[0.05] bg-white/68 p-5 backdrop-blur-xl dark:border-white/[0.05] dark:bg-void-900/35">
              ...
              <div className="mt-4 flex flex-wrap items-end justify-between gap-4">
                ...
                <div className="rounded-xl border border-signal-500/15 bg-signal-500/8 px-4 py-3 text-right dark:bg-signal-500/10">
              ...
              <div className="mt-5 grid gap-3 md:grid-cols-3">
                <div className="rounded-xl border border-black/[0.05] bg-black/[0.025] px-4 py-3 dark:border-white/[0.05] dark:bg-white/[0.03]">
            ...
            <div className="xl:col-span-5 space-y-3">
              <div className="rounded-xl border border-black/[0.05] bg-white/68 p-4 backdrop-blur-xl dark:border-white/[0.05] dark:bg-void-900/35">
          ...
          <div className="mt-3 rounded-xl border border-black/[0.05] bg-white/68 p-4 backdrop-blur-xl dark:border-white/[0.05] dark:bg-void-900/35">

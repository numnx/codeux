...
const STATUS_BADGE_TONES: Record<SprintStatus, string> = {
  running: "border-status-green/30 bg-status-green/15 text-emerald-700 dark:text-emerald-400",
  paused: "border-ember-500/30 bg-ember-500/15 text-amber-700 dark:text-ember-400",
  completed: "border-black/[0.1] bg-black/[0.06] text-slate-600 dark:border-white/[0.1] dark:bg-white/[0.06] dark:text-slate-300",
  failed: "border-status-red/30 bg-status-red/15 text-red-700 dark:text-red-400",
    ...
    >
      <td className="px-4 py-3 pl-6 align-top">
        <button
          ...
          className="inline-flex items-center justify-center text-slate-500 transition-colors hover:text-signal-500"
        >
          {isSelected
        ...
        <button
          ...
          className={`inline-flex h-10 w-10 items-center justify-center rounded-full border transition-colors ${
            sprint.showcasePinned
              ...
              : "border-black/[0.06] bg-black/[0.03] text-slate-500 hover:text-status-red dark:border-white/[0.06] dark:bg-white/[0.03]"
      ...
      <td className="px-4 py-3 min-w-[8rem] align-top">
        ...
        <div className="mt-1 text-[10px] font-bold uppercase tracking-[0.14em] text-slate-500 truncate">
          {shortenId(sprint.id)}
        </div>
      </td>
      <td className="px-4 py-3 min-w-0 max-w-full align-top">
        ...
        {sprint.goal ? (
          <p className={`mt-2 max-w-xl text-sm leading-relaxed ${isCompleted ? "text-slate-500 dark:text-slate-400" : "text-slate-600 dark:text-slate-400"}`}>
            {sprint.goal}
          </p>
        ) : null}
      </td>
      ...
      <td className="px-4 py-3 align-top">
        ...
        <div className="text-[10px] uppercase tracking-[0.14em] text-slate-500">planned tasks</div>
      </td>
      ...
      <td className="px-4 py-3 align-top">
        ...
        <div className="mt-1 text-[10px] uppercase tracking-[0.14em] text-slate-500">created</div>
      </td>

  ...
  return (
    <>
      <button
        ...
        className={`inline-flex h-8 min-w-0 flex-1 whitespace-nowrap items-center justify-center gap-2 rounded-lg border px-3 text-xs font-bold transition-colors focus-visible:ring-2 focus-visible:ring-signal-500/30 sm:flex-none ${
          isPaused

    ...
    return (
        ...
        >
            ...
            <a href="/" className="px-7 mb-10 flex items-center gap-3 group cursor-pointer relative z-10 w-fit">
                <div aria-hidden="true" className="w-9 h-9 rounded-xl bg-void-900 dark:bg-[#F9F8F4] p-[1px] shadow-[0_0_16px_rgba(0,224,160,0.2)] group-hover:shadow-[0_0_24px_rgba(0,224,160,0.35)] transition-shadow duration-500">
                    <div className="w-full h-full bg-[#F9F8F4] dark:bg-void-900 rounded-lg flex items-center justify-center">
                ...
                {navItems.map((item, idx) => {
                    ...
                    return (
                        <button
                            ...
                            className="relative flex items-center gap-3.5 px-5 py-3 rounded-xl transition-colors duration-200 w-full text-left group overflow-hidden mb-0.5 focus:outline-none focus-visible:ring-2 focus-visible:ring-signal-500/40 focus-visible:rounded-xl focus-visible:z-10"
                        >
                            <div className={`absolute inset-0 rounded-xl transition-opacity duration-300 pointer-events-none ${isActive ? 'bg-signal-500/8 dark:bg-signal-500/10 opacity-100' : 'bg-transparent opacity-0 group-hover:bg-black/[0.03] dark:group-hover:bg-white/[0.03] group-hover:opacity-100'}`} />
                            <div className={`absolute inset-0 rounded-xl pointer-events-none transition-all duration-300 ${isActive ? 'shadow-[inset_0_0_0_1px_rgba(0,224,160,0.12)] dark:shadow-[inset_0_0_0_1px_rgba(0,224,160,0.1)]' : 'shadow-none'}`} />
            ...
            <div className="px-4 relative z-10">
                <button aria-label="Settings" className="relative w-full flex items-center gap-3.5 px-5 py-3 rounded-xl transition-colors duration-200 text-left group overflow-hidden focus:outline-none focus-visible:ring-2 focus-visible:ring-signal-500/40 focus-visible:rounded-xl focus-visible:z-10">
                    <div className="absolute inset-0 rounded-xl bg-transparent group-hover:bg-black/[0.03] dark:group-hover:bg-white/[0.03] transition-opacity duration-300 pointer-events-none opacity-0 group-hover:opacity-100" />

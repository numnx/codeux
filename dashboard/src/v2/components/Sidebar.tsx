...
export const Sidebar: FunctionComponent<SidebarProps> = ({ isOpen, onClose }) => {
    ...
    return (
        <>
            ...
            <aside
                ref={sidebarRef}
                className={`fixed lg:sticky top-0 left-0 z-[70] lg:z-40 w-[280px] h-screen shrink-0 border-r border-black/[0.05] dark:border-white/[0.04] bg-[#F5F3EF] dark:bg-void-900 flex flex-col justify-between py-8 transition-transform duration-500 ease-out lg:translate-x-0 ${isOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'}`}
            >
                ...
                {/* Logo */}
                <a href="/" className="px-7 mb-10 flex items-center gap-3 group cursor-pointer relative z-10 w-fit focus:outline-none focus-visible:ring-2 focus-visible:ring-signal-500/50 rounded-2xl touch-target">
                    <div aria-hidden="true" className="w-9 h-9 rounded-2xl bg-void-900 dark:bg-[#F9F8F4] p-[1px] shadow-[0_0_16px_rgba(0,224,160,0.25)] group-hover:shadow-[0_0_24px_rgba(0,224,160,0.35)] transition-shadow duration-500">
                    ...
                    {navItems.map((item, idx) => {
                        ...
                        return (
                            <button
                                ...
                                className="relative flex items-center gap-3.5 px-5 py-3.5 rounded-2xl transition-colors duration-200 w-full text-left group overflow-hidden mb-0.5 focus:outline-none focus-visible:ring-2 focus-visible:ring-signal-500/40 focus-visible:rounded-2xl focus-visible:z-10 touch-target"
                            >
                ...
                <div className="px-4 relative z-10">
                    <button 
                        ...
                        className="relative w-full flex items-center gap-3.5 px-5 py-3.5 rounded-2xl transition-colors duration-200 text-left group overflow-hidden focus:outline-none focus-visible:ring-2 focus-visible:ring-signal-500/40 focus-visible:rounded-2xl focus-visible:z-10 touch-target"
                    >

...
const GitCIStatusPanel: FunctionComponent<GitCIStatusPanelProps> = memo(({ status, error }) => {
  ...
  if (!status) {
    return (
      <div role="status" aria-live="polite" className="group relative overflow-hidden rounded-[1.75rem] border border-black/[0.06] bg-white/80 p-7 shadow-sm backdrop-blur-sm dark:border-white/[0.06] dark:bg-void-800/75">
  ...
  return (
    <div aria-live="polite" className="group relative overflow-hidden rounded-[1.75rem] border border-black/[0.06] bg-white/80 p-7 shadow-sm backdrop-blur-sm dark:border-white/[0.06] dark:bg-void-800/75">

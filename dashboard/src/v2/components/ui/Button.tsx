...
const VARIANTS = {
  primary: "bg-void-950 text-white shadow-[0_4px_12px_rgba(0,0,0,0.3)] hover:bg-void-800 dark:bg-white dark:text-void-900 dark:hover:bg-void-50",
  secondary: "border border-void-900/[0.06] bg-white/72 text-void-500 hover:text-void-900 dark:border-white/[0.06] dark:bg-white/[0.03] dark:text-void-300 dark:hover:text-white",
  danger: "border border-status-red/30 bg-status-red/[0.06] text-status-red hover:bg-status-red/[0.12]",
  ghost: "bg-transparent text-void-400 hover:text-void-700 dark:hover:text-void-200 hover:bg-void-900/[0.03] dark:hover:bg-white/[0.03]",
  signal: "bg-signal-500 hover:bg-signal-400 text-void-900 shadow-[0_4px_20px_rgba(0,224,160,0.35)] hover:shadow-[0_8px_32px_rgba(0,224,160,0.5)] disabled:shadow-none",
};

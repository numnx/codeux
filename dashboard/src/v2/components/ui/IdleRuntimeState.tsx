...
export const IdleRuntimeState: FunctionComponent<{
    ...
    <div className="relative overflow-hidden rounded-[1.75rem] border border-black/[0.08] bg-white p-10 min-h-[18rem] flex items-center justify-center shadow-sm dark:border-white/[0.08] dark:bg-void-800">

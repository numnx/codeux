...
export const BorderTrace: FunctionComponent<{ accentHex: string }> = ({ accentHex }) => (
    <>
        ...
        <div className="absolute bottom-0 left-0 right-0 h-[1px] overflow-hidden">
            <div
                className="h-full w-full origin-center scale-x-0 group-hover:scale-x-100 group-focus-visible:scale-x-100 motion-safe:transition-transform motion-safe:duration-700 motion-safe:ease-[cubic-bezier(0.4,0,0.2,1)] transform-gpu"
        ...
        <div className="absolute left-0 top-0 bottom-0 w-[1px] overflow-hidden">
            <div
                className="w-full h-full origin-bottom scale-y-0 group-hover:scale-y-[0.7] group-focus-visible:scale-y-[0.7] motion-safe:transition-transform motion-safe:duration-500 motion-safe:ease-out motion-safe:delay-200 transform-gpu"

      ...
      >
        <div className="relative w-56 shrink-0 bg-void-900 dark:bg-void-950 flex flex-col justify-between p-8 overflow-hidden">
          ...
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
            <div className={`w-44 h-44 ${mode === "import" ? "bg-signal-500/[0.08]" : "bg-ember-500/[0.08]"} rounded-full`}  />
            <div className={`absolute w-28 h-28 ${mode === "import" ? "bg-signal-500/[0.14]" : "bg-ember-500/[0.14]"} rounded-full`}  />
          </div>

...
export const WaveFluid: FunctionComponent<{ accentHex: string }> = ({ accentHex }) => (
    <div className="absolute bottom-0 left-0 right-0 h-16 overflow-hidden pointer-events-none opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 transition-opacity duration-700 ease-">

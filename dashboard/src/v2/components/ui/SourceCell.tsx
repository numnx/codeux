...
const statusMap = {
    ...
    idle:         { ring: '',                                                               text: 'text-slate-500 dark:text-slate-400', icon: FolderGit2, label: "Idle" },
} as const;
    ...
    return (
        ...
        >
            ...
            <div className="relative z-20 flex flex-col items-center justify-center text-center p-5 w-full h-full transform-gpu group-hover:translate-z-12 transition-transform duration-500 ease-out">
                ...
                <div className="mt-1.5 flex gap-3 text-xs font-semibold text-slate-600 dark:text-slate-400 group-hover:opacity-0 transition-opacity duration-300">

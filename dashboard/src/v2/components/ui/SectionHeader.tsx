...
export const SectionHeader: FunctionComponent<SectionHeaderProps> = ({
    ...
    <header className={`flex items-end justify-between px-2 overflow-hidden ${className}`}>
        <div className="relative">
            <h2 aria-hidden="true" className="text-[6rem] font-black tracking-tighter text-black/[0.04] dark:text-white/[0.04] absolute -top-8 -left-3 pointer-events-none select-none font-display leading-none overflow-hidden">
                {watermark}
            </h2>

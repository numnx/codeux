          ...
          <div data-composer-stagger className="mt-8 grid gap-4 sm:grid-cols-2">
            <div className="rounded-[1.4rem] border border-black/[0.06] bg-black/[0.025] p-4 dark:border-white/[0.06] dark:bg-white/[0.03]">
              ...
              <select
                ...
                className="w-full bg-transparent text-sm font-semibold text-slate-700 dark:text-slate-300 rounded-lg px-1 py-0.5 -ml-1"
                required
              >
              ...
              <div className="flex gap-2 flex-wrap">
                {STATUS_OPTIONS.map((option) => (
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-xl text-[10px] font-bold uppercase tracking-[0.12em] transition-all ${ state.status === option ? "bg-signal-500 text-void-900 shadow-[0_2px_12px_rgba(0,224,160,0.3)]" : "text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-slate-200" }`}
                  >
                    {option.replace("_", " ")}
                  </button>
                ))}
            ...
            <div className="grid gap-4 xl:grid-cols-2">
              <div className="rounded-[1.7rem] border border-black/[0.07] bg-black/[0.025] dark:border-white/[0.08] dark:bg-white/[0.03]">
                <textarea
                  ...
                  className="min-h-[160px] w-full resize-none rounded-[1.7rem] bg-transparent px-4 py-4 text-sm leading-relaxed text-slate-700 outline-none placeholder:text-slate-300 dark:text-slate-300 dark:placeholder:text-slate-600 sm:px-5"
                />
              </div>
              ...
              <div className="rounded-[1.7rem] border border-black/[0.07] bg-black/[0.025] dark:border-white/[0.08] dark:bg-white/[0.03]">
                <textarea
                  ...
                  className="min-h-[160px] w-full resize-none rounded-[1.7rem] bg-transparent px-4 py-4 text-sm leading-relaxed font-mono text-slate-700 outline-none placeholder:text-slate-300 dark:text-slate-300 dark:placeholder:text-slate-600 sm:px-5"
                />
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-2 gap-2">
              {PRIORITY_OPTIONS.map((option) => (
                <button
                  ...
                  className={`px-3 py-2 rounded-[1.1rem] border text-[10px] font-bold uppercase tracking-[0.12em] transition-all text-center ${ state.priority === option ? "border-ember-500/45 bg-ember-500/[0.08] text-ember-600 dark:text-ember-400" : "border-black/[0.06] bg-black/[0.025] text-slate-500 dark:border-white/[0.06] dark:bg-white/[0.03] dark:text-slate-400" }`}
                >
                  {option}
                </button>
              ))}

...
export const SprintSettingsOverrideModal: FunctionComponent<SprintSettingsOverrideModalProps> = ({
  ...
  return (
    ...
    >
      <div
        ref={cardRef}
        className="flex max-h-[92vh] w-full max-w-7xl flex-col overflow-hidden rounded-xl bg-[#f9f8f4] shadow-[0_48px_96px_rgba(0,0,0,0.25)] dark:bg-void-900 dark:shadow-[0_48px_96px_rgba(0,0,0,0.7)]"
      >
        <SettingsHeader

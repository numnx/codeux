...
export const MetricCard: FunctionComponent<MetricCardProps> = ({ children, hoverTint, accentHex }) => (
    <div className="relative overflow-hidden bg-void-50/70 dark:bg-void-800/60 backdrop-blur-2xl border border-void-900/[0.06] dark:border-void-50/[0.06] rounded-[1.75rem] p-7 shadow-[0_2px_20px_rgba(0,0,0,0.04)] dark:shadow-[0_4px_24px_rgba(0,0,0,0.2)] flex flex-col justify-between group stat-card-premium">
        {/* Hover tint */}

    ...
    <div className="relative z-10 mx-auto flex max-w-4xl flex-col items-start gap-6 text-left">
      ...
      <div className="mt-4 flex flex-wrap gap-4">
        <button
          ...
          className="group inline-flex items-center gap-2 rounded-full bg-signal-500 px-6 py-3 font-bold text-slate-900 shadow-[0_0_20px_rgba(0,224,160,0.3)] transition-all hover:scale-105 hover:bg-signal-400 hover:shadow-[0_0_30px_rgba(0,224,160,0.5)]  focus:ring-4 focus:ring-signal-500/30 disabled:cursor-not-allowed disabled:opacity-50 disabled:hover:scale-100"
        >
        ...
        <button
          ...
          className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-6 py-3 font-bold text-white backdrop-blur-sm transition-all hover:bg-white/10  focus:ring-4 focus:ring-white/10 disabled:cursor-not-allowed disabled:opacity-50"
        >
          <RefreshCw

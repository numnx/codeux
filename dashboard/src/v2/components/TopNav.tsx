...
import { Bell, Command, Search, Moon, Sun, ChevronDown, Activity, FolderOpen, ArrowRight, Cpu, Zap, Compass, Menu, X } from "lucide-preact";
...
export const TopNav: FunctionComponent<TopNavProps> = ({ isDark, toggleTheme, sidebarOpen, setSidebarOpen }) => {
    ...
    return (
        ...
        <header
            ref={navRef}
            className="sticky top-0 z-50 flex items-center justify-between w-full h-[60px] px-4 md:px-12 bg-[#F9F8F4]/70 dark:bg-void-900/70 backdrop-blur-3xl border-b border-black/[0.05] dark:border-white/[0.04]"
        >
            ...
            <div className="flex items-center gap-4 md:gap-10 flex-1">
                ...
                <button
                    ...
                    className="flex md:hidden items-center justify-center w-11 h-11 rounded-xl hover:bg-black/[0.05] dark:hover:bg-white/[0.05] transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-signal-500/50 touch-target"
                >
                    {sidebarOpen ? <X aria-hidden="true" className="w-5 h-5" /> : <Menu aria-hidden="true" className="w-5 h-5" />}
                </button>
                ...
                <div className="relative group w-full max-w-xs hidden sm:block">
                    ...
                    <div className="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                        <kbd aria-hidden="true" className="hidden lg:inline-flex items-center gap-0.5 px-1.5 py-0.5 text-[9px] font-mono font-medium text-slate-400 border border-black/10 dark:border-white/10 rounded-md">
            ...
            <div className="flex items-center gap-2 md:gap-3">
                {/* Project Selector */}
                <div className="relative hidden lg:block" ref={dropdownRef} onKeyDown={projectKb.onContainerKeyDown}>
                    <button
                        ...
                        className="flex items-center gap-2.5 px-3.5 py-2 bg-black/[0.04] dark:bg-white/[0.04] border border-transparent hover:border-black/[0.08] dark:hover:border-white/[0.08] rounded-xl transition-all group focus:outline-none focus-visible:ring-2 focus-visible:ring-signal-500/50 touch-target"
                    >
                        ...
                        <div role="listbox" aria-label="Project list" className="absolute right-0 top-full mt-2 w-56 bg-white/95 dark:bg-void-800/95 backdrop-blur-2xl border border-black/[0.06] dark:border-white/[0.08] rounded-2xl shadow-[0_20px_40px_rgba(0,0,0,0.12)] dark:shadow-[0_20px_40px_rgba(0,0,0,0.4)] overflow-hidden z-50">
                            ...
                            {projects.map((source) => (
                                <button
                                    ...
                                    className={`focus-visible:ring-2 focus-visible:ring-signal-500/50 w-full flex items-center gap-2.5 px-3 py-2.5 text-left hover:bg-signal-500/5 transition-colors group touch-target ${selectedProject?.id === source.id ? 'bg-signal-500/8' : ''}`}
                                >
                            ...
                            <div className="p-2 border-t border-black/[0.04] dark:border-white/[0.04] mt-1 flex flex-col gap-1">
                                <button
                                    ...
                                    className="focus-visible:ring-2 focus-visible:ring-signal-500/50 w-full flex items-center gap-2 px-3 py-2 text-xs font-semibold text-ember-600 dark:text-ember-400 hover:bg-ember-500/[0.06] rounded-xl transition-colors touch-target"
                                >
                ...
                {/* Sprint Selector */}
                {selectedProject && (
                    <div className="relative hidden xl:block" ref={sprintDropdownRef} onKeyDown={sprintKb.onContainerKeyDown}>
                        <button
                            ...
                            className={`focus:outline-none focus-visible:ring-2 focus-visible:ring-signal-500/50 flex items-center gap-2.5 px-3.5 py-2 bg-black/[0.04] dark:bg-white/[0.04] border border-transparent rounded-xl transition-all group touch-target ${
                                sprints.length > 0
                        ...
                        {sprintDropdownOpen && sprints.length > 0 && (
                            <div role="listbox" aria-label="Sprint list" className="absolute right-0 top-full mt-2 w-56 bg-white/95 dark:bg-void-800/95 backdrop-blur-2xl border border-black/[0.06] dark:border-white/[0.08] rounded-2xl shadow-[0_20px_40px_rgba(0,0,0,0.12)] dark:shadow-[0_20px_40px_rgba(0,0,0,0.4)] overflow-hidden z-50">
                                ...
                                <button
                                    ...
                                    className={`focus-visible:ring-2 focus-visible:ring-signal-500/50 w-full flex items-center gap-2.5 px-3 py-2.5 text-left hover:bg-signal-500/5 transition-colors group touch-target ${selectedSprintId === null ? 'bg-signal-500/8' : ''}`}
                                >
                                ...
                                {sprints.map((sprint) => (
                                    <button
                                        ...
                                        className={`focus-visible:ring-2 focus-visible:ring-signal-500/50 w-full flex items-center gap-2.5 px-3 py-2.5 text-left hover:bg-signal-500/5 transition-colors group touch-target ${selectedSprintId === sprint.id ? 'bg-signal-500/8' : ''}`}
                                    >
                ...
                {/* Worker Selector */}
                {selectedProject && (
                    <div className="relative hidden xl:block" ref={workerDropdownRef} onKeyDown={workerKb.onContainerKeyDown}>
                        <button
                                ...
                                <div className="max-h-64 overflow-y-auto">
                                    {workerOptions.map((option) => (
                                        <button
                                            ...
                                            className={`focus-visible:ring-2 focus-visible:ring-signal-500/50 w-full flex items-center gap-3 px-3 py-3 text-left transition-colors group touch-target ${
                ...
                <div className="w-px h-5 bg-black/10 dark:bg-white/10 hidden lg:block" />
                ...
                <button
                    ...
                    className="relative w-11 h-11 flex items-center justify-center rounded-xl hover:bg-black/[0.05] dark:hover:bg-white/[0.05] transition-colors group focus:outline-none focus-visible:ring-2 focus-visible:ring-signal-500/50 touch-target"
                >
                ...
                <button
                    ...
                    className="w-11 h-11 flex items-center justify-center rounded-xl hover:bg-black/[0.05] dark:hover:bg-white/[0.05] transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-signal-500/50 touch-target"
                >
                    {isDark
                ...
                {/* Avatar */}
                <button aria-label="Profile" className="flex items-center gap-2.5 cursor-pointer group focus:outline-none focus-visible:ring-2 focus-visible:ring-signal-500/50 rounded-full touch-target">

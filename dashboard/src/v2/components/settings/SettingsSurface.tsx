...
export const SettingsHeader: FunctionComponent<{
  ...
  <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-5 border-b border-black/[0.05] px-5 py-5 sm:px-7 sm:py-6 dark:border-white/[0.04]">
    <div>

...
export const CATEGORIES: Category[] = [
  ...
  { id: "modelPricing", num: "04", label: "Model Pricing", icon: Banknote, description: "Per-model token pricing sourced from models.dev, with your own overrides" },
...
export const CATEGORY_SEARCH_HINTS: Record<CategoryId, string[]> = {
  ...
  modelPricing: ["pricing", "price", "cost", "token", "models.dev", "override", "billing", "usage"],

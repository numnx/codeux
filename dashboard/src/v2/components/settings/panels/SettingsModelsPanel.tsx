              ...
              {expanded ? (
                <div id={detailsId} className="grid gap-3">
                  <Row label="Eligible by default" description="Controls whether this instance participates before route-specific overrides are applied.">
                    <Toggle aria-description="Controls whether this instance participates before route-specific overrides are applied." aria-label="Eligible by default" value={provider.enabled} onChange={(value) => updateProviderSettings(providerConfigId, { enabled: value })} />
                  </Row>
                    ...
                    {expanded ? (
                      <div id={detailsId} className="grid gap-3">
                        <Row label="Enabled override" description="Override route participation for this one instance.">
                          <Toggle aria-description="Override route participation for this one instance." aria-label="Enabled override" value={override.enabled ?? provider.enabled} onChange={(value) => updateRouteProviderOverride(activeRouteDefinition.id, providerConfigId, { enabled: value })} />
                        </Row>
                        {supportsModel ? (

  ...
  return (
    <div className="flex flex-col gap-5">
      <SectionCard title="Project Markdown Mirror" watermark="AGT" badge={getBadge("agents")} icon={<FileText strokeWidth={2.4} />}>
        ...
        >
          <Toggle aria-description="When enabled, dashboard edits write a companion markdown file under `.code-ux/agents` for the selected project. Default and home agent files are never modified." aria-label="Save agent markdown to project directory"             value={editableSettings.agents.saveToProjectDirectory}

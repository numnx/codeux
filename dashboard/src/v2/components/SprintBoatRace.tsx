                    ...
                    <div className="relative z-10 flex items-center justify-center py-10">
                        <div className="text-center">
                            <div className="relative inline-flex items-center justify-center w-20 h-20 mb-6">
                                ...
                                <Anchor className="w-7 h-7 text-slate-500 dark:text-white/20" strokeWidth={1.2} />
                            </div>
                            <p className="text-[10px] font-bold uppercase tracking-[0.3em] text-slate-600 dark:text-white/25">Fleet Awaiting Departure</p>
                            <p className="text-[11px] text-slate-500/60 dark:text-white/12 mt-3 font-mono max-w-xs mx-auto">
            ...
            <div className="relative overflow-hidden">
                ...
                <div className="relative z-20 flex items-center justify-between px-8 pt-5 pb-1">
                    <div className="flex items-center gap-3">
                        ...
                        <span className="text-[9px] font-bold uppercase tracking-[0.25em] text-slate-600 dark:text-white/35">Sprint Race</span>
                        <span className="text-[8px] font-mono text-slate-500 dark:text-white/15 ml-1">
                            {activeShips.length + harbourCount} vessel{(activeShips.length + harbourCount) !== 1 ? "s" : ""}
                        </span>
                    </div>
                    <div className="flex items-center gap-5 text-[7px] font-mono text-slate-500 dark:text-white/20 uppercase tracking-wider">

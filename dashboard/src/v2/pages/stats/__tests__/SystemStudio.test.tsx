...
describe("SystemStudio", () => {
  it("renders telemetry, responds to filtering, and toggles row expansion", async () => {
    ...
    fireEvent.click(screen.getByRole("button", { name: /Expand details for invocation/i }));
    ...
    fireEvent.click(screen.getByRole("button", { name: /Collapse details for invocation/i }));

    ...
    <div className="relative z-10 mx-auto flex max-w-[1920px] flex-col gap-10 px-6 py-16 md:px-12 xl:px-20">
      ...
      <div ref={headerRef} className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_360px] xl:items-end">
        <div className="flex flex-col gap-5">
          <div className="flex items-center gap-2.5 text-[10px] font-bold uppercase tracking-[0.2em] text-slate-500 font-mono">
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            <div className="rounded-full border border-black/[0.06] bg-white/70 px-4 py-2 text-xs font-semibold text-slate-600 backdrop-blur-2xl dark:border-white/[0.06] dark:bg-void-800/60 dark:text-slate-300">
              {activeScope === "system"
        ...
        <div className="rounded-[1.75rem] border border-black/[0.06] bg-white/76 p-4 backdrop-blur-2xl shadow-[0_18px_40px_rgba(15,23,42,0.05)] dark:border-white/[0.06] dark:bg-void-800/66 dark:shadow-[0_24px_52px_rgba(0,0,0,0.24)]">
          ...
          <div className="mt-3 flex items-center gap-3 rounded-[1.2rem] border border-black/[0.06] bg-black/[0.03] px-4 py-3 dark:border-white/[0.06] dark:bg-white/[0.03]">
            <Search className="h-4 w-4 shrink-0 text-slate-500" strokeWidth={2.1} />
            <input
            ...
            />
            <div className="rounded-full border border-black/[0.06] bg-white/80 px-2.5 py-1 text-[10px] font-bold uppercase tracking-[0.14em] text-slate-500 dark:border-white/[0.06] dark:bg-white/[0.04]">
              /
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 items-start gap-8 lg:grid-cols-[300px_1fr]">
        ...
        <div ref={contentRef} className="flex min-w-0 flex-col gap-5">
          <div className="mb-1 flex flex-wrap items-center gap-3">
            ...
            <span className="rounded-full border border-black/[0.06] bg-black/[0.03] px-3 py-1 text-[10px] font-bold uppercase tracking-[0.14em] text-slate-600 dark:border-white/[0.06] dark:bg-white/[0.04] dark:text-slate-300">

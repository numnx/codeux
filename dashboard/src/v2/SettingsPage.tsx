...
export const SettingsPage: FunctionComponent = () => {
  ...
  return (
    <PageContainer padding="settings" className="gap-10">
      ...
      <div ref={headerRef} className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_360px] lg:items-end">
        <div className="flex flex-col gap-5">
          ...
          <div className="relative overflow-hidden">
            ...
            <h1 className="relative z-10 font-display text-5xl font-black leading-[0.92] tracking-tighter text-slate-900 dark:text-white md:text-7xl break-words">
              Settings
              <br />
        ...
        <div className="rounded-[1.75rem] border border-black/[0.06] bg-white/70 p-4 backdrop-blur-2xl shadow-[0_2px_20px_rgba(0,0,0,0.04)] dark:border-white/[0.06] dark:bg-void-800/60 dark:shadow-[0_4px_24px_rgba(0,0,0,0.2)] max-w-full min-w-0">
      ...
      <div className="grid grid-cols-1 items-start gap-8 lg:grid-cols-[280px_1fr] xl:grid-cols-[300px_1fr]">

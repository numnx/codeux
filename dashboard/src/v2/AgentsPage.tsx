    ...
    >
      ...
      <div className="relative z-10 flex flex-col gap-5">
        ...
        <label className="space-y-2">
          <span className="text-[9px] font-bold uppercase tracking-[0.16em] text-slate-500">Agent Name</span>
          <input
            value={name}
        ...
        <label className="space-y-2">
          <span className="text-[9px] font-bold uppercase tracking-[0.16em] text-slate-500">Instruction Markdown</span>
          <textarea
        ...
        {preset.sourcePath && (
          <div className="rounded-[1.25rem] border border-black/[0.06] bg-black/[0.025] px-4 py-3 text-xs leading-relaxed text-slate-600 dark:border-white/[0.06] dark:bg-white/[0.03] dark:text-slate-400">
            <div className="text-[9px] font-bold uppercase tracking-[0.16em] text-slate-500">Markdown Source</div>
        ...
        <div className="flex items-center justify-between border-t border-black/[0.05] pt-4 text-[10px] font-mono dark:border-white/[0.05]">
          <span className="truncate text-slate-500">{preset.id}</span>
          <button
            type="button"

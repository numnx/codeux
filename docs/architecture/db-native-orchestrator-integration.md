...
- keeps Docker or CLI-backed execution and hosted execution under the same dispatch flow
...
- `hosted_provider` provider (hosted) -> `hosted_provider` dispatch executor

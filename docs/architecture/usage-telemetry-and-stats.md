...
Note: Stats snapshot components are modularized into independent pure boundaries for usage costing (`project-stats-costing`), duration distributions (`project-stats-duration`), and chart-series construction (`project-stats-chart-series`).

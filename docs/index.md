...
6. [Atomic Sprint Loop](./sprint-loop/atomic-loop.md)
7. [Instruction Template System](./instructions/markdown-template-system.md)
8. [Configuration and Storage](./settings/configuration-and-storage.md)

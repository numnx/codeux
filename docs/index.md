...
16. [MCP Connections And Listen Mode](./architecture/mcp-connections-and-listen-mode.md)
17. [MCP Worker Dispatch Executor](./architecture/mcp-worker-dispatch-executor.md)
18. [External MCP Worker Client](./architecture/external-mcp-worker-client.md)
19. [Atomic Sprint Loop](./sprint-loop/atomic-loop.md)
20. [Instruction Template System](./instructions/markdown-template-system.md)
21. [Configuration and Storage](./settings/configuration-and-storage.md)

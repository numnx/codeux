...
14. [Connection And Listener Foundation Reset](./architecture/connection-and-listener-foundation-reset.md)
15. [MCP Connections And Listen Mode](./architecture/mcp-connections-and-listen-mode.md)
16. [MCP Worker Dispatch Executor](./architecture/mcp-worker-dispatch-executor.md)
17. [External MCP Worker Client](./architecture/external-mcp-worker-client.md)
18. [Atomic Sprint Loop](./sprint-loop/atomic-loop.md)
19. [Instruction Template System](./instructions/markdown-template-system.md)
20. [Configuration and Storage](./settings/configuration-and-storage.md)

...
10. [Project Management Implementation](./architecture/project-management-implementation.md)
11. [Project Runtime Integration](./architecture/project-runtime-integration.md)
12. [MCP Connections And Listen Mode](./architecture/mcp-connections-and-listen-mode.md)
13. [MCP Worker Dispatch Executor](./architecture/mcp-worker-dispatch-executor.md)
14. [Atomic Sprint Loop](./sprint-loop/atomic-loop.md)
15. [Instruction Template System](./instructions/markdown-template-system.md)
16. [Configuration and Storage](./settings/configuration-and-storage.md)

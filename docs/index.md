...
13. [MCP Connections And Listen Mode](./architecture/mcp-connections-and-listen-mode.md)
14. [MCP Worker Dispatch Executor](./architecture/mcp-worker-dispatch-executor.md)
15. [External MCP Worker Client](./architecture/external-mcp-worker-client.md)
16. [Atomic Sprint Loop](./sprint-loop/atomic-loop.md)
17. [Instruction Template System](./instructions/markdown-template-system.md)
18. [Configuration and Storage](./settings/configuration-and-storage.md)

...
*   Runtime logs and effective settings display reflect scoped project/sprint overrides natively; `SettingsContentPanels` components must not re-evaluate the scope cascade locally.

...
- The sprint composer now features a visible, animated planning feedback overlay that replaces the generic spinner during `Plan ahead with AI`, `Plan Only`, `Plan & Start`, `Replan`, `Save Draft`, and `Append Tasks` actions.

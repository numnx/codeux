...
- Dashboard API caches (`livePayloadCache`, `overviewTelemetryCache`, etc) respect configurable TTLs (e.g., 5 seconds) to bound data freshness and strictly do not cache rejected promises or abort errors.

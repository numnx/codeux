...
## Task Composer Validation Notes
Task Composer Validation:
- Validation occurs before submit, and errors are delayed until submit is attempted or a field is touched and blurred.
- Improved validation flow highlights the first invalid field upon form submission to easily guide user attention to missing fields.
- Reduced-motion settings are respected during first-invalid-field focus shake animations.

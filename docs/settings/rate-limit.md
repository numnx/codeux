...
> Settings area: `rate-limit`
> Dashboard documentation route: `/docs/settings-rate-limit`

## What This Area Is For

Controls retries after provider quota or rate-limit responses. This page expands the short Settings-page help text into an operator reference for deciding when to change this area, what behavior the controls affect, and what to verify after saving.

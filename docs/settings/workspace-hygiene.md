...
> Settings area: `workspace-hygiene`
> Dashboard documentation route: `/docs/settings-workspace-hygiene`

## What This Area Is For

Controls cleanup of temporary worktree state after provider CLI runs. This page expands the short Settings-page help text into an operator reference for deciding when to change this area, what behavior the controls affect, and what to verify after saving.

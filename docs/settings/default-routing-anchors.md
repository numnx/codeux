...
> Settings area: `default-routing-anchors`
> Dashboard documentation route: `/docs/settings-default-routing-anchors`

## What This Area Is For

Sets the global and worker provider instances used when invocation routes inherit defaults. This page expands the short Settings-page help text into an operator reference for deciding when to change this area, what behavior the controls affect, and what to verify after saving.

...
> Settings area: `system-database`
> Dashboard documentation route: `/docs/settings-system-database`

## What This Area Is For

Wipes the local Code UX database so the app returns to a clean state on reload. This page expands the short Settings-page help text into an operator reference for deciding when to change this area, what behavior the controls affect, and what to verify after saving.

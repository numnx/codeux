...
> Settings area: `project-context`
> Dashboard documentation route: `/docs/settings-project-context`

## What This Area Is For

Names and identifies the active project without changing the stored project id or execution history. This page expands the short Settings-page help text into an operator reference for deciding when to change this area, what behavior the controls affect, and what to verify after saving.

...
| Area | What it covers |
| --- | --- |
| [Speech Output Architecture](/docs/architecture-speech-output) | Installs and activates STT/TTS ONNX bundles, configures API variants, and controls the 3D Chat project-manager voice. |

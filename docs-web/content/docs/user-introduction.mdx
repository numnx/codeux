...
[Installation](/docs/user-installation) to get set up, then [Quickstart](/docs/user-quickstart) to run your first
sprint.
...
one model and repair CI with another. See [Providers and models](/docs/user-providers-and-models).
...
- [Install Code UX](/docs/user-installation)
- [Run your first sprint](/docs/user-quickstart)
- [Providers and models](/docs/user-providers-and-models)
- [Use Code UX from an MCP client](/docs/user-mcp-clients)

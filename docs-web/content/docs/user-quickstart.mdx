...
- Code UX [installed](/docs/user-installation).
...
> [Project initialization](/docs/user-dashboard-projects).
...
See [Providers and models](/docs/user-providers-and-models) for routing work to different providers by
invocation type.
...
[Sprint format](/docs/developer-sprint-format) for the schema.
...
For the full lifecycle, see [Sprint orchestration](/docs/user-sprint-orchestration).
...
(see [MCP clients](/docs/user-mcp-clients)), you can ask it to list projects and plan or orchestrate a
sprint, and the same run appears live in the dashboard.

## Next steps

- Tune routing in [Providers and models](/docs/user-providers-and-models) — e.g. plan with one model, code
  with another.
- Set an [automation and CI policy](/docs/user-automation-and-ci).
- Save reusable shapes as [Quicksprint templates](/docs/user-quicksprints).
- Explore the [dashboard](/docs/user-dashboard-overview) surface by surface.

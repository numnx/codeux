...
- [Memory](/docs/user-dashboard-memory) is what the runtime *learns* automatically — short-term sprint evidence and long-term project claims captured from completed work.

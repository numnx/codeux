...
Semantic search requires an active embedding model. Knowledge uses the same local embedding models managed on the [Memory](/docs/user-dashboard-memory) page. If search returns

...
Hidden pages remain registered routes, Docs opens the external project docs, and Sprint Preview Browser still follows the project sprint-preview visibility settings.

...
> **Authentication:** The dashboard REST API is intended for trusted local consumption. It is not authenticated. Bind only to loopback (default) or front it with a reverse proxy when exposing remotely. Like API routes, responses are non-cacheable and host-checked where security boundaries are discussed.
...
| Method | Path | Returns |
| --- | --- | --- |
| `GET` | `/health` | `{ "status": "UP" }` — liveness (from `CodeUxServer.getHealthStatus` checking settings DB, dashboard bind, and MCP service health). |
| `GET` | `/ready` | `{ "components": { "settingsDb", "dashboardBind", "mcpService" } }` — readiness (from `CodeUxServer.getReadinessStatus`). |
| `GET` | `/api/status` | High-level system status snapshot. |
| `GET` | `/api/system/update-status` | System update availability. |
...
| `GET` | `/api/docs-web` | List developer documentation. |
| `GET` | `/api/docs-web/:docId` | Get specific documentation page. |
...
| `POST` | `/api/projects/:projectId/setup` | Project setup flow. |
| `GET` | `/api/projects/:projectId/instruction-files/:fileId` | Get instruction file. |
| `PUT` | `/api/projects/:projectId/instruction-files/:fileId` | Update instruction file. |
...
| `POST` | `/api/projects/:projectId/tasks/:taskId/force-complete` | Force complete task. |
...
| `POST` | `/api/user/onboarding/cancel` | Cancel onboarding. |
| `POST` | `/api/user/onboarding/reset` | Reset onboarding. |
...
| `POST` | `/api/projects/:projectId/agent-presets/push` | Push presets. |
...
| `GET` | `/api/projects/:projectId/scheduler/memory-remediation` | Get memory remediation state. |
| `PUT` | `/api/projects/:projectId/scheduler/memory-remediation` | Set memory remediation state. |
...
| `DELETE` | `/api/projects/:projectId/memories` | Clear project memories. |
| `DELETE` | `/api/system/memories` | Clear system memories. |
| `GET` | `/api/projects/:projectId/memory-claims` | List memory claims. |
| `GET` | `/api/memory-claims/:claimId/evidence` | Get memory claim evidence. |
| `POST` | `/api/projects/:projectId/memories/search` | Vector search. |
| `POST` | `/api/projects/:projectId/memory-claims/search` | Search memory claims. |
...
| `POST` | `/api/projects/:projectId/knowledge/documents/upload` | Upload knowledge documents. |
| `POST` | `/api/projects/:projectId/knowledge/search` | Semantic search over the project's documents. |
| `GET` | `/api/projects/:projectId/knowledge/documents/:documentId` | Get a document within project scope. |
| `GET` | `/api/knowledge/documents/:documentId` | Get a document. |
| `DELETE` | `/api/projects/:projectId/knowledge/documents/:documentId` | Delete a document within project scope. |
| `DELETE` | `/api/knowledge/documents/:documentId` | Delete a document. |
| `POST` | `/api/projects/:projectId/knowledge/documents/:documentId/reembed` | Re-embed a document within project scope. |
...
| Method | Path | Description |
| --- | --- | --- |
| `POST` | `/api/terminal/start` | Start interactive terminal. |
| `POST` | `/api/terminal/stop` | Stop terminal. |
| `POST` | `/api/terminal/heartbeat` | Terminal heartbeat. |
| `POST` | `/api/terminal/finalize` | Finalize terminal. |

...
Anything you can do from this panel (rerun, stop, edit) is also available via the MCP API — see [Management actions → tasks](/docs/developer-management-actions#tasks).

...
7. **mergeProtocol** — Run the [CI gate](/docs/user-automation-and-ci): create PRs, watch CI, auto-merge per policy, surface attention items for conflicts and CI failures.

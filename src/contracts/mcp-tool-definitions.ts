  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        defaultTaskCount: { type: "number", description: "Optional default task count for a custom template." },
        taskCount: { type: "number", description: "Optional task count for execute/start; defaults to 5." },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        taskCount: { type: "number", description: "Flattened quicksprint task count; defaults to 5." },

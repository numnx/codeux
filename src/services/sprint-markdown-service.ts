...
function toMergeIndicator(value: string | null): "CI" | "AUTOMERGE" | "MERGED" | "MERGE_BLOCKED" | "MERGE_CONFLICT" | "PR_CREATED" | undefined {
  if (value === "CI" || value === "AUTOMERGE" || value === "MERGED" || value === "MERGE_BLOCKED" || value === "MERGE_CONFLICT" || value === "PR_CREATED") {
    return value;
  }
  return undefined;
}

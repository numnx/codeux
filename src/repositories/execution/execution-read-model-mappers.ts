...
export function mapExecutionInvocationRow(row: ExecutionInvocationRow): ExecutionInvocationRecord {
  return {
    ...
    provider: row.provider,
    model: row.model,
    executionMode: row.execution_mode as ExecutionInvocationRecord["executionMode"],
    ...
    promptChars: row.prompt_chars !== undefined && row.prompt_chars !== null ? toNumber(row.prompt_chars) : 0,
    transcriptChars: row.transcript_chars !== undefined && row.transcript_chars !== null ? toNumber(row.transcript_chars) : 0,

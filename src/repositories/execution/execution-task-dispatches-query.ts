...
import { compareExecutionTaskDispatchRows } from "../../domain/execution/execution-logic.js";
...
export function queryExecutionTaskDispatches(
  ...
  const taskDispatches = [...taskDispatchById.values()].sort(compareExecutionTaskDispatchRows);
